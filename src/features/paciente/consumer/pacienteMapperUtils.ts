...
import type { PacienteResponse, EnderecoResponse } from "../types/CarregarPacienteResponse";
import type { PacienteResumoResponse } from "../types/BuscarPacienteResponse";

export function enderecoToDomain(e?: EnderecoProjection | null): EnderecoResponse | null {
  if (!e) return null;
  return {
...
export function pacienteToDomain(p: PacienteProjection): PacienteResponse {
  return {
    id: p.id,
    nome: p.nome,
    cpf: p.cpf ?? null,
    ...
    idade: p.idade ?? "",
    endereco: enderecoToDomain(p.endereco),
...
export function pacienteResumoToDomain(r: PacienteResumoProjection): PacienteResumoResponse {
  return {
    id: r.id,
    nome: r.nome,
    cpf: r.cpf,
